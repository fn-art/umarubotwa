...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN?
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6285935379225:+62 859-3537-9225\n' // JANGAN KEK BABI SU
            + 'END:VCARD'
prefix = '.'
blocked = []
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6285935379225@s.whatsapp.net"] // replace this with your number
			const adminbotnumber = ["6285935379225@s.whatsapp.net"]
			const frendsowner = ["6285935379225@s.whatsapp.net"]
               ...
               case 'infogempa':
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `[ *UMARU BROADCAST* ]\n\n${body.slice(4)}`)
						}
						reply('Suksess broadcast')
					}
					break
